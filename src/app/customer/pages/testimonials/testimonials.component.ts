...
export class TestimonialsComponent {
  ...
  testimonials: Testimonial[] = [
    {
      img: `${environment.imageUrl}/products/cocktail/coolblue.png`,
      title: 'Kiara',
    ...
    {
      img: `${environment.imageUrl}/products/cocktail/appletini.png`,
      title: 'Vihaan',
    ...
    {
      img: `${environment.imageUrl}/products/burgers/doubleburger.png`,
      title: 'Ira',
    ...
    {
      img: `${environment.imageUrl}/products/pizza/cheesilisious.png`,
      title: 'Ayaan',
    ...
    {
      img: `${environment.imageUrl}/products/cold-beverages/coldcoffee.png`,
      title: 'Saanvi',
    ...
    {
      img: `${environment.imageUrl}/products/beers/carlsberg-elephant.png`,
      title: 'Reyansh',
